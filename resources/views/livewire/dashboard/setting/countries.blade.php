        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">{{__('msg.countries')}}</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{route('dashboard')}}"
                                                           wire:navigate>{{__('msg.dashboard')}}</a></li>
                            <li class="breadcrumb-item active">{{__('msg.countries')}}</li>
                        </ol>
                    </div>
                ...
                <div class="card" id="customerList">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myModalLabel">{{__('msg.import_countries')}}</h5>
                                            ...
                                            <div class="live-preview">
                                                <div class="row gy-4">
                                                    ...
                                                    <div class="col-xxl-3 col-md-12">
                                                        ...
                                                        <a href="{{asset('assets/files/countries_example.xlsx')}}">{{__('msg.sample_file')}}</a>
                                                    </div>
                                                </div>
                    ...
                    <div class="modal fade" wire:ignore.self id="addItemModal" aria-hidden="true" aria-labelledby="..."
                        ...
                        <div class="modal-dialog modal-dialog-centered  modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myModalLabel">{{__('msg.add_new_country')}}</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                </div>
                                <div class="modal-body p-5">
                    ...
                    <div class="modal fade" wire:ignore.self id="editItemModal" aria-hidden="true" aria-labelledby="..."
                        ...
                        <div class="modal-dialog modal-dialog-centered  modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="myModalLabel">{{__('msg.edit_country')}}</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                </div>
                                <div class="modal-body p-5">
                    ...
                    <div class="card-header border-bottom-dashed">
                            ...
                            <div class="row g-4 align-items-center">
                                <div class="col-sm">
                                    <div>
                                        <h5 class="card-title mb-0">{{__('msg.countries')}}</h5>
                                    </div>
                                </div>
                                <div class="col-sm-auto">
                                    <div>
                                        ...
                                        <button type="button" class="btn btn-success add-btn cursor-pointer"
                                            ...
                                            <i class="ri-add-line align-bottom me-1"></i>{{__('msg.add_country')}}
                                        </button>
